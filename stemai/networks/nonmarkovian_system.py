...
class NonMarkovianSystem(Network):
    ...
    def __init__(
        ...
        self.internal_network.create_agents(incoming_cells = [self.external_seed_cell_idx], outgoing_cells = [self.external_seed_cell_idx], global_states = self.states, seed_node = 0)
        self.external_network.create_agents(incoming_cells = [self.internal_seed_cell_idx], outgoing_cells = [self.internal_seed_cell_idx], global_states = self.states, seed_node = 0)
